...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (Conductor.SONG.song.toLowerCase())
		{
			case 'senpai':
	...
	override function update(elapsed:Float)
	{
		...
		if (Conductor.SONG.song.toLowerCase() == 'roses')
			portraitLeft.visible = false;
		if (Conductor.SONG.song.toLowerCase() == 'thorns')
		{
			portraitLeft.visible = false;
			...
			if (dialogueEnded)
			{
				...
				if (dialogueList[1] == null && dialogueList[0] != null)
				{
					if (!isEnding)
					{
						...
						if (Conductor.SONG.song.toLowerCase() == 'senpai' || Conductor.SONG.song.toLowerCase() == 'thorns')
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			case 'dad':
				...
				{
					if (Conductor.SONG.song.toLowerCase() == 'senpai') portraitLeft.visible = true;
