...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		{
			Conductor.SONG = Song.parseJSONshit(FlxG.save.data.autosave);
		...
		var skin = Conductor.SONG.arrowSkin;
		if(skin == null) skin = '';
	...
	function loadJson(song:String):Void
	{
		...
		if (CoolUtil.difficulties[PlayState.storyDifficulty] != CoolUtil.defaultDifficulty) {
			if(CoolUtil.difficulties[PlayState.storyDifficulty] == null){
				Conductor.SONG = Song.loadFromJson(song.toLowerCase(), song.toLowerCase());
			}else{
				Conductor.SONG = Song.loadFromJson(song.toLowerCase() + "-" + CoolUtil.difficulties[PlayState.storyDifficulty], song.toLowerCase());
			}
		}else{
		Conductor.SONG = Song.loadFromJson(song.toLowerCase(), song.toLowerCase());
		}
