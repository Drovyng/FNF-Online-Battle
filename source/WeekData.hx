...
class WeekData {
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false)
	{
		...
		var modsListPath:String = 'mods/modsList.txt';
	...
	public static function loadTheFirstEnabledMod()
	{
		...
		#if MODS_ALLOWED
		if (FileSystem.exists("mods/modsList.txt"))
		{
			var list:Array<String> = CoolUtil.listFromString(File.getContent("mods/modsList.txt"));
